...
const Navbar = () => {
  ...
  return (
    <div className=" w-full  h-[4rem] mb-4 z-[10]  flex justify-end items-center border-b shadow-xl border-gray-800   ">
        ...
        >
          ...
          >
            <div className="ms-2 flex flex-col justify-start items-start  gap-2 mt-2">
              <div
                className={`flex justify-center items-center gap-4 ${isOpneMenue ? "opacity-100" : "opacity-0"}  transition-all duration-700`}
              >
              ...
              <div className={`flex justify-center items-center gap-4 ${isOpneMenue ? "opacity-100" : "opacity-0"}  transition-all duration-700 `}>
